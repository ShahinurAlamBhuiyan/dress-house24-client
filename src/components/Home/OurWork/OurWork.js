...
const OurWork = () => {
    return (
        <section className='mt-5 pb-3 fontContainer'>
            ...
            <div className='d-flex justify-content-center flex-wrap pt-4 mb-3'>
                <img style={{width:'400px', height:'500px', marginLeft:'10px', marginBottom:'4px'}} src={workImg1} alt=""/>
                <img style={{width:'400px', height:'500px', marginLeft:'10px', marginBottom:'4px'}} src={workImg2} alt=""/>
                <img style={{width:'400px', height:'500px', marginLeft:'10px', marginBottom:'4px'}} src={workImg3} alt=""/>
            </div>
        </section>
    );
};
