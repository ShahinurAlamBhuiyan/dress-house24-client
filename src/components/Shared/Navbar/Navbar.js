                ...
                <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item d-flex justify-content-center">
                            {
                                loggedInUser.email ? <button onClick={handleLogOut} className='btn btn-danger  text-white nav-link'>LogOut</button> : <button onClick={()=> history.push('/login')} className='btn btn-primary text-white nav-link'>Login</button>
                            }
                        </li>
                    </ul>
                </div>
